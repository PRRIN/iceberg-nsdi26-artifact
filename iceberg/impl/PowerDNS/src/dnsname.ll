...
attributes #0 = { noinline ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
attributes #4 = { mustprogress noinline ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #5 = { mustprogress noinline noreturn ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #6 = { nounwind "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #7 = { mustprogress noinline nounwind ssp uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #8 = { "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
attributes #10 = { mustprogress nofree noinline nounwind ssp willreturn memory(read) uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
attributes #13 = { nofree nounwind "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
attributes #16 = { noinline noreturn nounwind "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
attributes #18 = { cold noreturn "disable-tail-calls"="true" "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #19 = { nobuiltin nounwind "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #20 = { mustprogress nofree noinline nosync nounwind ssp willreturn memory(argmem: readwrite) uwtable(sync) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
attributes #21 = { nobuiltin allocsize(0) "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
...
!13 = distinct !{!13, !9, !10}
!14 = !{!15, !16, i64 0}
!15 = !{!"_ZTSNSt3__117basic_string_viewIcNS_11char_traitsIcEEEE", !16, i64 0, !17, i64 8}
...
!24 = !{!"short", !6, i64 0}
!25 = !{!26}
!26 = distinct !{!26, !27, !"_ZN5boost9container12basic_stringIcNSt3__111char_traitsIcEEvE6rbeginEv: argument 0"}
!27 = distinct !{!27, !"_ZN5boost9container12basic_stringIcNSt3__111char_traitsIcEEvE6rbeginEv"}
!28 = distinct !{!28, !9, !10}
!29 = distinct !{!29, !9, !10}
!30 = distinct !{!30, !9, !10}
!31 = distinct !{!31, !9, !10}
...
!34 = distinct !{!34, !9, !10}
!35 = !{!36, !16, i64 8}
!36 = !{!"_ZTSNSt3__16vectorINS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEENS4_IS6_EEEE", !16, i64 0, !16, i64 8, !37, i64 16}
!37 = !{!"_ZTSNSt3__117__compressed_pairIPNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEENS4_IS6_EEEE", !38, i64 0}
!38 = !{!"_ZTSNSt3__122__compressed_pair_elemIPNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEELi0ELb0EEE", !16, i64 0}
!39 = !{!36, !16, i64 0}
!40 = distinct !{!40, !9, !10}
!41 = distinct !{!41, !9, !10}
!42 = distinct !{!42, !9, !10}
...
!48 = distinct !{!48, !9, !10}
!49 = !{!50, !17, i64 136}
!50 = !{!"_ZTSN7DNSName16RawLabelsVisitorE", !51, i64 0, !16, i64 128, !17, i64 136}
!51 = !{!"_ZTSNSt3__15arrayIhLm128EEE", !6, i64 0}
!52 = !{!50, !16, i64 128}
!53 = !{!54, !54, i64 0}
!54 = !{!"vtable pointer", !7, i64 0}
!55 = !{!56, !16, i64 16}
!56 = !{!"_ZTSN5boost9container3dtl17basic_string_baseINS0_13new_allocatorIcEEE6long_tE", !17, i64 0, !17, i64 0, !17, i64 8, !16, i64 16}
!57 = !{!56, !17, i64 8}
!58 = !{!59, !16, i64 0}
!59 = !{!"_ZTSNSt3__14pairIPKcS2_EE", !16, i64 0, !16, i64 8}
!60 = !{!59, !16, i64 8}
!61 = !{!62, !16, i64 0}
!62 = !{!"_ZTSNSt3__14pairIPKcPcEE", !16, i64 0, !16, i64 8}
!63 = !{!62, !16, i64 8}
!64 = !{i64 0, i64 24, !5, i64 0, i64 24, !5, i64 0, i64 1, !5, i64 0, i64 1, !5, i64 1, i64 23, !5, i64 0, i64 24, !5}
!65 = !{i64 0, i64 1, !5, i64 0, i64 1, !5, i64 1, i64 23, !5}
!66 = distinct !{!66, !9, !10}
!67 = distinct !{!67, !9, !10}
!68 = distinct !{!68, !9, !10}
!69 = distinct !{!69, !9, !10}
!70 = !{!71, !16, i64 8}
!71 = !{!"_ZTSN5boost9container9exceptionE", !72, i64 0, !16, i64 8}
!72 = !{!"_ZTSSt9exception"}
!73 = distinct !{!73, !9, !10}
!74 = distinct !{!74, !9, !10}
!75 = !{!76, !77, i64 0}
!76 = !{!"_ZTSNSt3__113basic_ostreamIcNS_11char_traitsIcEEE6sentryE", !77, i64 0, !16, i64 8}
!77 = !{!"bool", !6, i64 0}
!78 = !{i8 0, i8 2}
!79 = !{}
!80 = !{!81, !22, i64 8}
!81 = !{!"_ZTSNSt3__18ios_baseE", !22, i64 8, !17, i64 16, !17, i64 24, !22, i64 32, !22, i64 36, !16, i64 40, !16, i64 48, !16, i64 56, !16, i64 64, !17, i64 72, !17, i64 80, !16, i64 88, !17, i64 96, !17, i64 104, !16, i64 112, !17, i64 120, !17, i64 128}
!82 = !{!83, !22, i64 144}
!83 = !{!"_ZTSNSt3__19basic_iosIcNS_11char_traitsIcEEEE", !81, i64 0, !16, i64 136, !22, i64 144}
!84 = !{!85, !16, i64 0}
!85 = !{!"_ZTSNSt3__119ostreambuf_iteratorIcNS_11char_traitsIcEEEE", !16, i64 0}
!86 = !{!81, !17, i64 24}
!87 = distinct !{!87, !9, !10}
!88 = !{!81, !16, i64 40}
!89 = !{!81, !22, i64 32}
!90 = !{!91, !16, i64 8}
!91 = !{!"_ZTSNSt3__16vectorINS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEENS4_IS6_EEE21_ConstructTransactionE", !16, i64 0, !16, i64 8, !16, i64 16}
!92 = !{!93, !16, i64 16}
!93 = !{!"_ZTSNSt3__114__split_bufferINS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEERNS4_IS6_EEEE", !16, i64 0, !16, i64 8, !16, i64 16, !94, i64 24}
!94 = !{!"_ZTSNSt3__117__compressed_pairIPNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEERNS4_IS6_EEEE", !38, i64 0, !95, i64 8}
!95 = !{!"_ZTSNSt3__122__compressed_pair_elemIRNS_9allocatorINS_12basic_stringIcNS_11char_traitsIcEENS1_IcEEEEEELi1ELb0EEE", !16, i64 0}
!96 = !{!91, !16, i64 16}
!97 = !{!91, !16, i64 0}
!98 = !{!93, !16, i64 8}
!99 = !{!93, !16, i64 0}
...
!105 = !{!106, !16, i64 8}
!106 = !{!"_ZTSNSt3__116reverse_iteratorIPNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEEEE", !16, i64 0, !16, i64 8}
!107 = !{i64 0, i64 8, !43, i64 8, i64 8, !43, i64 16, i64 8, !43}
!108 = !{!109, !77, i64 24}
!109 = !{!"_ZTSNSt3__128__exception_guard_exceptionsINS_29_AllocatorDestroyRangeReverseINS_9allocatorINS_12basic_stringIcNS_11char_traitsIcEENS2_IcEEEEEENS_16reverse_iteratorIPS7_EEEEEE", !110, i64 0, !77, i64 24}
!110 = !{!"_ZTSNSt3__129_AllocatorDestroyRangeReverseINS_9allocatorINS_12basic_stringIcNS_11char_traitsIcEENS1_IcEEEEEENS_16reverse_iteratorIPS6_EEEE", !16, i64 0, !16, i64 8, !16, i64 16}
!111 = !{!110, !16, i64 0}
!112 = !{!110, !16, i64 16}
!113 = !{!110, !16, i64 8}
...
!117 = !{!118, !16, i64 0}
!118 = !{!"_ZTSNSt3__16vectorINS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEENS4_IS6_EEE16__destroy_vectorE", !16, i64 0}
!119 = distinct !{!119, !9, !10}
!120 = distinct !{!120, !9, !10}
!121 = distinct !{!121, !9, !10}
!122 = !{!123, !16, i64 0}
!123 = !{!"_ZTSNSt3__111__wrap_iterIPNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEEEE", !16, i64 0}
!124 = !{i64 0, i64 8, !43}
